...
function Bhartiartl()
{
    ...
    return(
       <>
       <Link to="/BHARTIARTL">    </Link>
        <Navbar/>
        <hr></hr>
        <div className="about">
            <h2 className="heading">Bharti Airtel Ltd.</h2>
            <h4 className="ticker">TICKER:BHARTIARTL.NS</h4>
            <p className="about_com">
            Bharti Airtel Limited, commonly known as (d/b/a) Airtel, is an Indian multinational telecommunications services company based 
            in New Delhi. It operates in 18 countries across South Asia and Africa, as well as the Channel Islands. Currently, 11Airtel provides
             4G and 4G+ ser12vices all over India and 5G service in selected cities. Currently offered services include fixed-line broadband, 
