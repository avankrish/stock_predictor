...
function Axisbank()
{
    ...
    return(
       <>
       <Link to="/AXISBANK">    </Link>
        <Navbar/>
        <hr></hr>
        <div className="about">
            <h2 className="heading">Axis Bank Ltd.</h2>
            <h4 className="ticker">TICKER:AXISBANK.NS</h4>
            <p className="about_com">
            Axis Bank Limited, formerly known as UTI Bank (1993–2007), is an Indian banking and financial services company headquartered 
            in Mumbai, Maharashtra. It sells financial services to large and mid-size companies, SMEs and retail businesses. The bank was
             founded on 3 December 1993 as UTI Bank, opening its registered office in Ahmedabad and a corporate office in Mumbai.
            </p>
        </div>
        <div>
