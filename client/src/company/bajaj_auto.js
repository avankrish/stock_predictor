...
function Bajaj_auto()
{
    ...
    return(
       <>
       <Link to="/BAJAJ-AUTO">    </Link>
        <Navbar/>
        <hr></hr>
        <div className="about">
            <h2 className="heading">Bajaj Auto Ltd.</h2>
            <h4 className="ticker">TICKER:BAJAJ-AUTO.NS</h4>
            <p className="about_com">
            Bajaj Auto Limited is an Indian multinational automotive manufacturing company based in Pune.
             It manufactures motorcycles, scooters, and auto rickshaws. Bajaj A8uto is a part of the Bajaj Group. 
             It wa9s founded by Jamnalal Bajaj (1889–1942) in Rajasthan in the 1940s.
